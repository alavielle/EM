...
If ($pos>0)
	...
	If ($erreur=False:C215)
		...
		End for each 
		$entity.save()
		SauvegarderStorageEtatCivil($entity.ID; $ReceivedObject.Nom; $ReceivedObject.NomNaissance; $ReceivedObject.DateNaissance; $ReceivedObject.CP; $ReceivedObject.Ville; $ReceivedObject.Tel; $ReceivedObject.Email; $ReceivedObject.Prenom; $entity.CodeDossier; $ReceivedObject.Type)
	End if 
	$0:=$return
End if 