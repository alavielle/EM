...
ALL RECORDS:C47([PoleSocial:17])
$composant:=Crud($1; ->[PoleSocial:17]; ds:C1482.PoleSocial)
...
$Contenu:=Replace string:C233($Contenu; "$title$"; "Pôles")
$Contenu:=Replace string:C233($Contenu; "$url$"; "Poles")
