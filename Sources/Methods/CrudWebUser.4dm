...
OB SET:C1220($objMesChamps; "Privilege"; ->[Privilege:4]Profil:2)
...
$Contenu:=Replace string:C233($Contenu; "$displayMail$"; "")
$Contenu:=Replace string:C233($Contenu; "$TypeEnvoi$"; "FirstLogin")
